...
export function Sidebar({ links, isCollapsed, isMobile }: SidebarProps) {
  return (
    ...
    >
      ...
      <nav className="grid gap-1 px-2 group-[[data-collapsed=true]]:justify-center group-[[data-collapsed=true]]:px-2 border-2 border-green-500">
            ...
            >
              ...
              <div className="flex flex-col max-w-28">
                ...
                {link.messages.length > 0 && (
                  <span className="text-txt-color text-xs truncate ">
